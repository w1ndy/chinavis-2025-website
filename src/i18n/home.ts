...
export const zh = {
  ...
  Content: marked.parse(
    ...
    **第十二届中国可视化与可视分析大会** (ChinaVis 2025) 将于 **2025 年 7 月 19 日 - 22 日**在**杭州**举行。本次大会由中国图象图形学学会主办，可视化与可视分析专委会、浙江大学、浙大城市学院、杭州全息智能技术研究院、浙江工业大学、杭州电子科技大学、浙江工商大学、浙江传媒学院、中国美术学院承办，多家赞助单位协办。本次大会内容包括特邀报告、论文报告、海报、展览、专题研讨及艺术项目。大会将邀请国内外可视化领域知名专家就相关研究与应用最新进展作大会报告，介绍发展动态，开拓研究思路。欢迎从事可视化与可视分析，以及相关领域研究的专家、学者、艺术家、学生以及工业界的专家、专业技术人员踊跃投稿与参会。
