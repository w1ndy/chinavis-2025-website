...
export const zh = {
  Title: "可视化竞赛 - ChinaVis 2025",
  PageTitle:
    "第十二届中国可视化与可视分析大会（ChinaVis 2025）<br />数据可视化竞赛征稿通知",
  Introduction: {
    Title: "数据可视化竞赛简介",
    Content:
  ...
  Track1: {
    Title: "赛道1：人文数据可视分析与可视化创意挑战赛",
    Problem1: {
      Title: "I. 「析城观史」可视分析挑战赛",
  ...
  Committee: {
    Title: "可视化竞赛委员会",
    Content:
      '<div class="font-bold zh-name">张慧杰</div><div>东北师范大学</div>' +
      '<div class="font-bold zh-name">陈静</div><div>南京大学</div>' +
      '<div class="font-bold zh-name">张俊杰</div><div>香港科技大学（广州）</div>' +
      '<div class="font-bold zh-name">徐进</div><div>杭州师范大学</div>',
  },
  History: {
    Title: "历届挑战赛回顾",
    Content: marked.parse(
...
export const en = {
  Title: "Data Challenge - ChinaVis 2025",
  PageTitle:
  ...
  Introduction: {
    Title: "Data Visualization Competition Introduction",
    Content:
  ...
  ChallengeDetails: {
    Title: "Data Visualization Competition Content",
    Content:
    ...
    Problem1: {
      ...
      Content: marked.parse(
        'Beijing, an ancient capital of the East with over 3,000 years of urban history and more than 800 years as a dynastic capital, has long been the political, cultural, and transportation heart of China. The evolution of this city is not merely a grand narrative of dynastic changes and administrative restructuring but is profoundly reflected in the shifts of water systems, fluctuations in climate, the aggregation and movement of populations and industries, as well as the dramatic impacts of natural disasters and conflicts. These multifaceted and intertwined spatiotemporal factors have collectively shaped Beijing’s spatial layout and urban functions, bearing witness to the enduring historical depth and dynamic transformations of Chinese civilization on the northern plains.  With the advancement of new-generation technologies such as Historical Geographic Information Systems (HGIS), digital archival organization, semantic annotation, and knowledge graph construction, scholars and the public can now transcend temporal constraints to systematically reconstruct Beijing’s evolutionary trajectory across different spatiotemporal scales. This technological progress offers unprecedented possibilities for a multidimensional understanding of "how Beijing became what it is today."  This visual analytics challenge focuses on the historical spatiotemporal evolution of Beijing, incorporating diverse and heterogeneous spatiotemporal data, including water systems, climate, vegetation, disasters, population, local products, transportation, wars, administrative changes, commerce, handicrafts, and major historical events. We encourage participants to break free from the constraints of traditional linear historical narratives, fully leveraging data analysis and visual expression techniques to restore the complex spatiotemporal evolution patterns of Beijing’s urban development from multiple dimensions. This endeavor aims to provide fresh perspectives for understanding historical transformations and offer insights for contemporary urban governance and future development.  Participants are tasked with designing and implementing a visual analytics solution to accomplish the following:\n' +
          ...
          "**Optional Data set: For detailed information, please refer to Track 1 Data.**\n\n" +
          '**<span style="color: #8b0000; font-weight: 700">Note：The dataset for Track 1-I is designated, please do not use self-selected datasets.</span>**'
      ),
    },
    Problem2: {
      Title:
        "II. 「Reflecting on the Past, Discussing the Present」 Visualization Creative Challenge",
      Content: marked.parse(
  ...
  Track2: {
    Title: "Track 2: Art Visualization Competition",
    Topic: 'Theme: "Hangzhou · Tide of Myriad Phenomena"',
    Introduction: marked.parse(
    ...
    Problem: {
      Title: "Artistic Visualization Student Competition",
      Content: marked.parse(
  ...
  Notes: {
    Title: "Instructions For Participation",
    Registration: {
      Title: "Registration",
      Content: marked.parse(
  ...
  Downloads: {
    Title: "Documentation Templates and Dataset Download",
    Content: marked.parse(
      "1. **Track 1-I: Visual Analytics Challenge**\n" +
        "    - Work description document template: [Download](/2025/challenge/1i_answer_sheet.docx)\n" +
        "    - Data download link: [Download](/2025/challenge/dataset.zip) (The data provided is limited to use in competition entries)\n" +
  ...
  Committee: {
    Title: "Organizing Committee Of The Visualization Competition",
    Content:
      '<div class="font-bold">Huijie Zhang</div><div>Northeast Normal University</div>' +
      '<div class="font-bold">Jing Chen</div><div>Nanjing University</div>' +
      '<div class="font-bold">Junjie Zhang</div><div>Hong Kong University of Science and Technology (Guangzhou)</div>' +
      '<div class="font-bold">Jin Xu</div><div>Hangzhou Normal University</div>',
  },
  History: {
    Title: "Previous Challenges Review",
    Content: marked.parse(
